...
public class MusicService extends MediaBrowserService {
    ...
    public void onCreate() {
        ...
        MediaMetadata metadata = new MediaMetadata.Builder()
                .putString(MediaMetadata.METADATA_KEY_TITLE, "歌曲歌曲歌曲")
                .putString(MediaMetadata.METADATA_KEY_ALBUM, "专辑专辑专辑")
                .build();
        ...
        // 获取通知管理器实例
        MediaNotificationManager mnManager = MediaNotificationManager.getInstance(getApplicationContext());
        // 获取通知实例
