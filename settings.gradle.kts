...
include(":M03_UI:C01_Common:S04_Widget")
include(":M03_UI:C01_Common:S05_Wallpaper")
include(":M03_UI:C01_Common:S06_Launcher")
include(":M03_UI:C01_Common:S07_SystemUI")
include(":M03_UI:C01_Common:S08_Window")
include(":M03_UI:C01_Common:S09_Display")
include(":M03_UI:C02_Resource:S01_Base")
include(":M03_UI:C02_Resource:S01_Base_ResPack")
...
include(":M03_UI:C08_CtrlCustom:S01_Universal")
include(":M03_UI:C08_CtrlCustom:S02_Process")
include(":M03_UI:C08_CtrlCustom:S03_Draw")
include(":M03_UI:C08_CtrlCustom:S04_Interaction")
include(":M03_UI:C08_CtrlCustom:S05_AnalogClock")
include(":M03_UI:C08_CtrlCustom:S06_PieProgressBar")
include(":M03_UI:C08_CtrlCustom:S07_FluidBorderLayout")
include(":M03_UI:C08_CtrlCustom:S08_BaseRVAdapter")
include(":M03_UI:C09_Animation:S01_Frame")
include(":M03_UI:C09_Animation:S02_Tween")
...
include(":M04_System:C01_Common:S02_Context")
include(":M04_System:C01_Common:S03_Intent")
include(":M04_System:C01_Common:S04_ComponentName")
include(":M04_System:C01_Common:S05_Bundle")
include(":M04_System:C01_Common:S06_Parcelable")
include(":M04_System:C02_Service:S01_Universal")
include(":M04_System:C02_Service:S02_StartService")
include(":M04_System:C02_Service:S03_BindService")
include(":M04_System:C02_Service:S04_LifeCycle")
include(":M04_System:C02_Service:S05_AIDL-Server")
include(":M04_System:C02_Service:S05_AIDL-Client")
include(":M04_System:C03_ContentProvider:S01_Universal")
...
include(":M04_System:C04_Broadcast:S01_Universal")
include(":M04_System:C04_Broadcast:S02_System")
include(":M04_System:C04_Broadcast:S03_Normal")
include(":M04_System:C04_Broadcast:S04_Ordered")
include(":M04_System:C04_Broadcast:S05_Local")
...
include(":M04_System:C05_Ability:S06_User")
include(":M04_System:C05_Ability:S07_Key")
include(":M04_System:C05_Ability:S08_NDK")
include(":M04_System:C06_MultiTask:S01_Base")
include(":M04_System:C06_MultiTask:S02_Handler")
include(":M04_System:C06_MultiTask:S03_Coroutine")
