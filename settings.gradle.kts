...
include(":M03_UI:C03_CtrlBase:S02_EditText")
include(":M03_UI:C03_CtrlBase:S03_Button")
include(":M03_UI:C03_CtrlBase:S04_RadioButton")
include(":M03_UI:C03_CtrlBase:S05_ToggleButton")
include(":M03_UI:C03_CtrlBase:S06_CheckBox")
include(":M03_UI:C03_CtrlBase:S07_ImageView")
include(":M03_UI:C03_CtrlBase:S10_SeekBar")
include(":M03_UI:C03_CtrlBase:S11_Toast")
include(":M03_UI:C03_CtrlBase:S12_AlertDialog")
include(":M03_UI:C04_CtrlExt:S01_RecyclerView")
include(":M03_UI:C04_CtrlExt:S02_ViewPager")
include(":M03_UI:C04_CtrlExt:S03_ViewPager2")
include(":M03_UI:C04_CtrlExt:S04_DialogFragment")
include(":M03_UI:C04_CtrlExt:S06_DrawerLayout")
...
include(":M03_UI:C08_Resource:S02_Text")
include(":M03_UI:C08_Resource:S03_Color")
