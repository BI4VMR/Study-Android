 ...
 * @since 1.0.0
 */
public class TestUIDiffUtilAsync extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btRefresh.setOnClickListener(v -> {
            ...
            // 更新列表
            adapter.submitList(newDatas);
        });

        // 重置按钮
        binding.btReset.setOnClickListener(v -> adapter.submitList(getTestDatas()));
    }
