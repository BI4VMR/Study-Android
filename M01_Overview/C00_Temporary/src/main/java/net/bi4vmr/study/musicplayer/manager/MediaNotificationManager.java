package net.bi4vmr.study.musicplayer.manager;
...
import net.bi4vmr.study.musicplayer.ui.PlayerActivity;
...
public class MediaNotificationManager {
    ...
    public Notification createNotification() {
        ...
        // 设置PendingIntent
        Intent nIntent = new Intent(mContext, PlayerActivity.class);
